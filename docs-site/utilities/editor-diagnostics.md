...
then have to keep a second copy of twenty rules — in Kotlin — in step with the TypeScript ones.
...
and the flat config above is enough: the same twenty rules, inline and in the Problems panel.

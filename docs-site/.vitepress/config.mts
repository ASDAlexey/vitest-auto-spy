...
const RU_LABEL: Record<string, string> = {
  ...
  'Worker stub': 'Заглушка Worker',
  'Frames and element boxes': 'Кадры и размеры элементов',
...
const SIDEBAR = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Worker stub', link: '/utilities/worker-stub' },
      { text: 'Frames and element boxes', link: '/utilities/frame-and-rect' },

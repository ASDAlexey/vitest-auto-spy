...
об этом до того, как что-либо патчить: без `onlyMethodsToSpyOn` на живом `Node` или другом
`EventTarget` он предупреждает через обычный канал неверных конфигураций

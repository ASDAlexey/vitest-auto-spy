...
| `vitest-auto-spy/angular`             | `provideAutoSpy`, `injectSpy`, `renderShallow`, `createWithAutoSpies`, `stable`/`flushEffects`, хелперы `mock*Prop` — матчеры, диагностика и дубли уехали в 6.0 к спутникам ниже                                                                        |
| `vitest-auto-spy/angular/diagnostics` | `enableAngularDiagnostics` и вся семья таймингов TestBed; спутник `/angular`, уехавший из него в 6.0                                                                                                                                                    |

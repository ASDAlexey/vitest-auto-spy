...
description: Подчёркивать антипаттерны vitest-auto-spy прямо во время написания спеки — двадцать поставляемых ESLint-правил, которые WebStorm и другие IDE от JetBrains показывают нативно, а VS Code, Cursor и Windsurf — через расширение ESLint.
---
...
в `off`: он ругается на рабочий код, поэтому его включают на последней миле, а не оставляют подчёркивать
мост, по которому ещё идут.

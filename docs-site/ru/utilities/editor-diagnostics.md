...
description: Подчёркивать антипаттерны vitest-auto-spy прямо во время написания спеки — сорок девять поставляемых ESLint-правил, которые WebStorm и другие IDE от JetBrains показывают нативно, а VS Code, Cursor и Windsurf — через расширение ESLint.
---
...
[`vitest-auto-spy/eslint-plugin`](/ru/utilities/eslint-plugin). Сорок девять правил по настоящему
...
поэтому правила загораются **прямо в коде, без установки плагина** — те же сорок девять проверок, в
...
бы держать вторую копию сорока девяти правил — на Kotlin — в согласии с TypeScript-овыми. Там, где путь через
...
и flat config выше уже достаточно: те же сорок девять правил, в коде и в панели Problems.
...
Каждое сообщение называет найденное и одно исправление, а заканчивается строкой `Docs:` со ссылкой на
раздел этого правила в [правилах ESLint](/ru/utilities/eslint-rules), так что правило никогда не
говорит только «не надо». Полные описания, серьёзности и рассуждение о том, какие правила чинят, а

...
description: По разделу на каждое из тридцати семи правил — что оно сообщает, на чём принимает решение, зачем оно в recommended, где сообщает о работающем коде и почему у него именно такая severity.
---
...
## Тридцать семь правил {#the-twenty-five-rules}

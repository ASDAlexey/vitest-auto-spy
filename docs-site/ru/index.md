...
features:
  ...
  - title: Двадцать правил линтера и кодмод
    details: 'ESLint-плагин подчёркивает старые паттерны прямо в редакторе, а кодмод из CLI переписывает сюиту на jest-auto-spies в диф, который можно прочитать до того, как оставить.'
...
<p class="vas-eyebrow">RU</p>

## Документация на английском

Переведён лендинг; страницы документации написаны по-английски и открываются в русском разделе как
есть. Переключатель языка держит вас на той же странице.

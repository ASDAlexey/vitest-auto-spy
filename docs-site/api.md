...
| `vitest-auto-spy/eslint-plugin`                                                                              | Twenty-eight flat-config lint rules that steer a suite onto these helpers                                                                                            |
...
`restoreWebStorage()` takes a working storage from — `null` says there is no window.

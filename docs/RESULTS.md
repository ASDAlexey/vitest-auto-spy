...
2. **ESLint + Prettier from the second reference suite, lib-relevant rules** → `.eslintrc.cjs`, `.prettierrc`.
...
7. **Super-strict tsconfig** → `tsconfig.json`. Matches and exceeds the the second reference suite one (adds

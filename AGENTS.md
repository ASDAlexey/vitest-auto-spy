...
| Call                               | Does                                                                                            |
| ---------------------------------- | ----------------------------------------------------------------------------------------------- |
| `provideHttpTesting(opts?)`        | `provideHttpClient()` + `provideHttpClientTesting()`; `{ verifyOnTeardown }` defaults to `true` |
...
| `verifyNoPendingRequests()`        | the teardown check by hand, for mid-test use or a suite with `verifyOnTeardown: false`          |

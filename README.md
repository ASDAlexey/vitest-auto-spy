...
[![minzipped size](https://img.shields.io/badge/minzip-26.4%20kB-brightgreen)](#install)
...
| `stubAnimationFrame(opts?)`                                                                                 | `/dom-stubs`                  | `requestAnimationFrame` / `cancelAnimationFrame` run on the spot or on `flush(timestamp?)`; a frame requested inside a frame waits for the next flush; `onError` intercepts a throwing callback                                                                                                                                                         |
